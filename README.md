...
├── static/
│   └── style.css                               # Frontend UI Style
├── .gitignore
├── app.py                                      # Flask application
├── Electronic_Product_Recommendation.ipynb         # Model training notebook
└── README.md
```

## Installation
```
git clone https://github.com/ujjwalkumar14b/Electronic_Product_Recommendation.git
cd Electronic_Product_Recommendation
